...
namespace ObjectDetectionLearning
{
    ...
    {
        public const string RetrainFilePath = @"E:\Repos\Big Projects\Praca-inzynierska\ObjectDetectionLearning\Images\VotObjects\vott-json-export\Inzynierka-export.json";
