...
class Program
{
    ...
    static async Task Main(string[] args)
    {
        ...
        var trainData = new List<TextData>
        {
            ...
            //Panda
            new TextData { Text = "znajdź mi pandę na tym zdjęciu", Label = "pandy" },
            new TextData { Text = "czy jest na tym zdjęciu panda?", Label = "pandy" },
            new TextData { Text = "szukam pandy na tej fotografii", Label = "pandy" },
            new TextData { Text = "widziałem pandę w tym obrazie", Label = "pandy" },
            new TextData { Text = "proszę pokaż mi pandę na zdjęciu", Label = "pandy" },
            new TextData { Text = "czy na tym zdjęciu jest panda", Label = "pandy" },
            new TextData { Text = "czy widzisz jakąś pandę na obrazku", Label = "pandy" },
            new TextData { Text = "pokaż mi, gdzie jest panda", Label = "pandy" },
            new TextData { Text = "wskaż pandę na tej fotografii", Label = "pandy" },
            new TextData { Text = "zlokalizuj pandę w kadrze", Label = "pandy" },
            new TextData { Text = "czy mógłbyś znaleźć pandę na tej ilustracji", Label = "pandy" },
            new TextData { Text = "poproszę o wskazanie pandy na obrazku", Label = "pandy" },
            new TextData { Text = "bądź tak miły i pokaż mi, gdzie jest panda", Label = "pandy" },
            new TextData { Text = "uprzejmie proszę o zlokalizowanie pandy na zdjęciu", Label = "pandy" },
            new TextData { Text = "czy na tym zdjęciu widać jakieś pandy jedzące bambusa?", Label = "pandy" },
            new TextData { Text = "pokaż mi grupę pand, jeśli są na obrazku", Label = "pandy" },
            new TextData { Text = "czy widzisz tu jakieś urocze pandy?", Label = "pandy" },
            new TextData { Text = "znajdź mi pandę siadającą na drzewie", Label = "pandy" },
            new TextData { Text = "czy na tym zdjęciu jest jakaś panda?", Label = "pandy" },
            new TextData { Text = "pokaż mi, gdzie na obrazku są pandy", Label = "pandy" },

            //Slon
            new TextData { Text = "znajdź mi słonia na tym zdjęciu", Label = "slon" },
            new TextData { Text = "czy jest na tym zdjęciu słoń?", Label = "slon" },
            new TextData { Text = "szukam słoni na tej fotografii", Label = "slon" },
            new TextData { Text = "widziałem słonia w tym obrazie", Label = "slon" },
            new TextData { Text = "proszę pokaż mi słonia na zdjęciu", Label = "slon" },
            new TextData { Text = "czy na tym zdjęciu jest słoń", Label = "slon" },
            new TextData { Text = "czy widzisz jakiegoś słonia na obrazku", Label = "slon" },
            new TextData { Text = "pokaż mi, gdzie jest słoń", Label = "slon" },
            new TextData { Text = "wskaż słonia na tej fotografii", Label = "slon" },
            new TextData { Text = "zlokalizuj słonia w kadrze", Label = "slon" },
            new TextData { Text = "czy mógłbyś znaleźć słonia na tej ilustracji", Label = "slon" },
            new TextData { Text = "poproszę o wskazanie słonia na obrazku", Label = "slon" },
            new TextData { Text = "bądź tak miły i pokaż mi, gdzie jest słoń", Label = "slony" },
            new TextData { Text = "uprzejmie proszę o zlokalizowanie słonia na zdjęciu", Label = "slon" },
            new TextData { Text = "czy na tym zdjęciu widać jakieś słonie kąpiące się w rzece?", Label = "slon" },
            new TextData { Text = "pokaż mi stado słoni, jeśli są na obrazku", Label = "slon" },
            new TextData { Text = "czy widzisz tu jakieś ogromne słonie?", Label = "slon" },
            new TextData { Text = "znajdź mi słonia idącego przez sawannę", Label = "slon" },
            new TextData { Text = "czy na tym zdjęciu jest jakaś samica słonia?", Label = "slon" },
            new TextData { Text = "pokaż mi, gdzie na obrazku są słonie", Label = "slon" },
